...
<body>
  ...
  <a href="#" class="w3-bar-item w3-button w3-green w3-mobile"><i class="fa fa-bed w3-margin-right"></i>Booking</a>
  <a href="http://localhost:8080/WebApplication8/mainpage.jsp" class="w3-bar-item w3-button w3-mobile">Home</a>
            <a href="http://localhost:8080/WebApplication8/localLogin.jsp" class="w3-bar-item w3-button w3-mobile">Login</a>
        </div>



<div id="id01" >
    <form class="modal-content" action="insertAdmin" method="post">
    <div class="container">
      ...
      <input type="text" placeholder="Enter Your Hotel Name " name="hname" required>
     ...
     <label for="hotel-image"><h1>Hotel</h1><b> Image</b></label><br><br>
       <!-- <input type="file"  placeholder="Select Your Hotel Image" name="pic" accept="image/*" required><br><br><br> -->

        <label for="hotel-des"><b>Description</b></label>
      <input type="text" placeholder="Enter Your Hotel Description " name="hotel-des" required>

       <label for="food-image"><h1>Food</h1><b> Image</b></label><br><br>
      <!-- <input type="file"  placeholder="Select Your Food Image" name="pic" accept="image/*" required><br><br><br>-->

         <label for="food-des"><b> Description</b></label>
      <input type="text" placeholder="Enter Your Food Description " name="Food-des" required>

      <label for="transport-service-image"><h1>Transport</h1><b> Service Image</b></label><br><br>
        <!-- <input type="file"  placeholder="Select Your Transport Service  Image" name="pic" accept="image/*" required><br><br><br>-->

         <label for="transport-des"><b> Description</b></label>
      <input type="text" placeholder="Enter Your Transport Service Description " name="transport-des" required>  
