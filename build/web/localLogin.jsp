<%-- 
    Document   : login
    Created on : Jun 3, 2019, 9:57:02 PM
    Author     : Cool Breeze
--%>
...
<body>
  ...
  <a href="http://localhost:8080/WebApplication8/signup.jsp" class="w3-bar-item w3-button w3-mobile">SignUp</a>
  ...
  <div id="id01">
    <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:600px">
      ...
      <div class="w3-center"><br>
        ...
        <img src="img/3.png" alt="Avatar" style="width:30%" class="w3-circle w3-margin-top">
      </div>

      <form class="w3-container" action="localLogin" method="post">
